...
class Ui_WizardSalesPage(object):
    def setupUi(self, WizardPage):
        ...
        self.gridLayout.addWidget(self.pushButton_delete, 0, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_insert, 0, 8, 1, 1)
    ...
    def retranslateUi(self, WizardPage):
        ...
        self.pushButton.setText(_translate("WizardPage", "View Items"))
